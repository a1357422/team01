...
<div class="table-responsive">
    <table class="table">
        ...
        <tr class='column_center'>
            ...
            <td>
                <font color=blue><a href="{{ route('users.edit',['id'=>$user->id]) }}" class="btn btn-primary btn-sm">修改資料</a></font>
            </td>
            <td>
                <font color=blue><a href="{{ route('users.change_pw',['id'=>$user->id]) }}" class="btn btn-secondary btn-sm">修改密碼</a></font>
            </td>
        </tr>
        @endforeach
    </table>
