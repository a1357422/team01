...
<head>
    ...
    <style>
        ...
        a{color:inherit;
            text-decoration:inherit}svg,video{display:block;vertical-align:middle}
        video{max-width:100%
            ;height:auto}
        /* center color */
        ...
        .antialiased{-webkit-font-smoothing:antialiased;
                    ...
                    background:linear-gradient(#ffffde, #bfffbf, #a1ffff)}
        .w-5{width:1.25rem}
        .w-8{width:2rem}
        .w-auto{width:auto}
        ...
        @media (min-width:1024px){.lg\:px-8{padding-left:2rem;
                                            padding-right:2rem}}
        ...
        .dark\:text-white{--text-opacity:1;
                        color:#fff;
                        color:rgba(255,255,255,var(--text-opacity))}
        .dark\:text-gray-400{--text-opacity:1;
                            color:#cbd5e0;
                            color:rgba(203,213,224,var(--text-opacity))}
        .dark\:text-gray-500{--tw-text-opacity:1;
                            color:#6b7280;
